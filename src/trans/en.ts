export const en = {
  ...
  aboutMe: {
    ...
    skillSet: 'Skill Set',
    title: 'About Me',
    desc: `Hey👋 My name is Lara and I am web and mobile developer during the day and a student at Concordia during the night!`,
  ...
  education: {
    ...
    concordiaDesc: "Bachlor's in Computer Science",
    dawson: 'Dawson College',
    dawsonDesc: 'DEC in Computer Science',
  },
  footer: {
    title: '{{icon}} Made by LaraMo ©{{year}}',
  },
  toast: {
    theme: {
      light: 'Let there be light! 💡',
      dark: 'Hello darkness my old friend... 🌚',
      christmas: 'Happy Holidays! 🎄',
      easter: "Don't worry, be hoppy. 🐰",
    },
  },
  common: {
    present: 'Present',
